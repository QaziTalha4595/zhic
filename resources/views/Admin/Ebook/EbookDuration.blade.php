            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800">Locations Report</div>
                            <form id="filterForm">
                            <div class="row mt-3">

                                <div class="form-group col-md-2" style="margin-right: 10px">

                                    <select name="read_age" id="read_age" class="form-control Read_Input slelect2" style="width:100%;">
                                ...
                                <div class="form-group col-md-4" style="margin-right: 10px">
                                    ...
                                    <select type="text" class="form-control slelect2" id="nationality" name="nationality"
                                        style="width:100%;">
                                ...
                                <div class="form-group col-md-4" style="margin-right: 10px">
                                    ...
                                    <select id="qualification" name="qualification" class="form-control required" style="width:100%;">
                                ...
                                <div class="form-group col-md-2">
                                    <input type="date" class="form-control" name="date_from" id="date_from" placeholder="Enter From Date" />
                                </div>
                                <div class="form-group col-md-2">
                                    <input type="date" class="form-control" name="date_to" id="date_to" placeholder="Enter To Date" />
                                </div>
...
function loadData(){
    ...
    var DataTable = $("#DataTable").DataTable({
        ...
        ajax: {
            url: "{{route('EbookLocationReport')}}",
            data: {
                age: $('#read_age').val(),
                user_nationality: $('#nationality').val(),
