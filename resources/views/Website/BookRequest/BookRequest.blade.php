        ...
        <div class="row">
            <div class="col-lg-6 mx-auto card BookReqCard">
                <form id="BookRequestForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control required" id="user_spoken" name="user_spoken"
                            placeholder="Enter user_spoken">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Nationality</label>
                        <input type="text" class="form-control required" id="user_nationality" name="user_nationality"
                ...
                <div class="button">
                    ...
                    <a href="javascript:void(0)" class="btn-1 text-white" onclick="BookRequestSend()">Submit</a>
                </div>
            </div>
...
function BookRequestSend() {
    ...
    $.ajax({
        type: "POST",
        url: "{{route('Admin-Book-Request-Send')}}",
        data: $("#BookRequestForm").serialize(),
